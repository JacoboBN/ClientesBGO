...
# =========================
# 2. CONTEO GLOBAL DE LOCALES POR RÓTULO (sobre todo el dataset)
# =========================

conteo_global_rotulos = (
    df.groupby("rotulo_norm")
    .agg(total_locales_rotulo=("id_local", "nunique"))
    .reset_index()
)
...
# Mínimo de locales por rótulo en TODO el dataset
min_locales_rotulo = st.sidebar.slider(
    "Mínimo de locales por mismo rótulo en todo el dataset",
    min_value=1,
    max_value=30,
    value=2
)
...
df_filtrado = df_filtrado[
    df_filtrado["total_locales_rotulo"] >= min_locales_rotulo
].copy()


# Máximo de locales por rótulo en TODO el dataset
max_locales_rotulo = st.sidebar.slider(
    "Máximo de locales por mismo rótulo en todo el dataset",
    min_value=1,
    max_value=200,
    value=12
)
...
df_filtrado = df_filtrado[
    df_filtrado["total_locales_rotulo"] <= max_locales_rotulo
].copy()


# =========================
# 4. PUNTO DE INICIO Y CÁLCULO DE DISTANCIA
# =========================
...
# =========================
# SCORE Y RECOMENDACIÓN DE LOCALES
# =========================
...
# =========================
# RECOMENDACIÓN DE VISITA POR ZONA
# =========================
